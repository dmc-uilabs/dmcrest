...
public class AWSUpload {
	...
	private static String sourceBucket = "dummy1";//System.getenv("S3SourceBucket");//dmc-uploads2";
	//private static String sourceKey = "test/cat.jpeg";
	
	//The Perm Bucket where resource
	private static String destBucket = "dummy2";//System.getenv("S3DestBucket");//"dmc-profiletest";

	private static String accessKey = "dummy3";//System.getenv("S3AccessKey");
	private static String secretKey = "dummy4";//System.getenv("S3SecretKey");
