...
public interface DMDIIMemberDao extends BaseRepository<DMDIIMember, Integer> {
	...
	Page<DMDIIMember> findDistinctByOrganizationNameLikeIgnoreCaseOrOrganizationAreasOfExpertiseNameContainsIgnoreCaseOrOrganizationDesiredAreasOfExpertiseNameContainsIgnoreCase(Pageable pageable, String name, String areaOfExpertiseName, String desiredAreaOfExpertisename);

	Long countDistinctByOrganizationNameLikeIgnoreCaseOrOrganizationAreasOfExpertiseNameContainsIgnoreCaseOrOrganizationDesiredAreasOfExpertiseNameContainsIgnoreCase(String name, String areaOfExpertiseName, String desiredAreaOfExpertisename);
