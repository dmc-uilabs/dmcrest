...
public class DomeProjectEntity extends DomeEntity {
	...
	public void setModelId(String projectId) {
	...
	public boolean equals(Object o) {
		...
		DomeProjectEntity domeEntity = (DomeProjectEntity) o;
		return Objects.equals(getType(), domeEntity.getType()) && Objects.equals(getName(), domeEntity.getName())
				...
				&& Objects.equals(projectId, domeEntity.projectId) && Objects.equals(version, domeEntity.version);
	}

	@Override
	public int hashCode() {
		return Objects.hash(getType(), getName(), getPath(), getDomeServer(), dateModified, description, projectId, version);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class DomeProjectEntity {\n");
