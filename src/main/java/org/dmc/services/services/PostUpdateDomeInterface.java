...
public class PostUpdateDomeInterface {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(version, postUpdateDomeInterface.version) && Objects.equals(modelId, postUpdateDomeInterface.modelId)
				&& Objects.equals(interfaceId, postUpdateDomeInterface.interfaceId) && Objects.equals(type, postUpdateDomeInterface.type)
				&& Objects.equals(name, postUpdateDomeInterface.name) && Objects.equals(path, postUpdateDomeInterface.path)
				&& Objects.equals(serviceId, postUpdateDomeInterface.serviceId) && Objects.equals(domeServer, postUpdateDomeInterface.domeServer)
				&& Objects.equals(inParams, postUpdateDomeInterface.inParams) && Objects.equals(outParams, postUpdateDomeInterface.outParams);
	}

	@Override
	public int hashCode() {
		return Objects.hash(version, modelId, interfaceId, type, name, path, serviceId, domeServer, inParams, outParams);
	}
