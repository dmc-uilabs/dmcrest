...
public class ServiceRunsController {
	...
	public ResponseEntity<GetServiceRun> serviceRunsPost(@RequestBody PostServiceRun body,
	...
	@RequestMapping(value = "/{id}", produces = { "application/json", "text/html" }, method = RequestMethod.PATCH)
	public ResponseEntity<GetServiceRun> serviceRunsIdPatch(@PathVariable("id") String id,
