...
public class ServiceAuthorsController {
  ...
  @RequestMapping(value = "/{autorhId}", 
    produces = { "application/json", "text/html" }, 
    method = RequestMethod.DELETE)
  public ResponseEntity<Void> serviceAuthorsAutorhIdDelete(
@PathVariable("autorhId") Integer autorhId){
      // do some magic!
  ...
  public ResponseEntity<ServiceAuthor> serviceAuthorsPost(
@RequestBody ServiceAuthor author){
      // do some magic!
