...
public class DomeAPIDao {
	...
	public String getChildren(DomeEntity domeEntity) throws DMCServiceException, IOException {
		...
		if (domeEntity.getType() == null) {
			...
			//Sample string --> data={\"type\":\"folder\",\"name\":\"Fracture-Mechanics\",\"path\":[30]}
			urlStr.append("data");
			urlStr.append("=");
			urlStr.append("{");
			...
			//Sample string --> "data={"version":1,"modelId":"aff647da-d82f-1004-8e7b-5de38b2eeb0f","description":"","dateModified":1416717607000,"type":"model","name":"Alpha","path":[30]}"
			urlStr.append("data");
			urlStr.append("=");
			urlStr.append("{");
