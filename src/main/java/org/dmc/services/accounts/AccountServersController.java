...
public class AccountServersController {
	...
	@RequestMapping(value = "/{serverID}", produces = { "application/json", "text/html" }, consumes = {
			"application/json", "text/xml" }, method = RequestMethod.DELETE)
	...
	@RequestMapping(value = "/{serverID}", produces = { "application/json", "text/html" }, consumes = {
			"application/json", "text/xml" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/{serverID}", produces = { "application/json", "text/html" }, consumes = {
			"application/json", "text/xml" }, method = RequestMethod.PATCH)
