...
public class Config {
	...
	public static final String DB_HOST = "jdbc:postgresql://" + "54.237.192.205";//System.getenv("DBip");//ec2-52-35-193-110.us-west-2.compute.amazonaws.com";// + System.getenv("DBip");
