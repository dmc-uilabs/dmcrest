...
public class ComponentListDao {
	...
	public ArrayList<org.dmc.services.components.Component> getComponentList(){
		
		ArrayList<org.dmc.services.components.Component> components = new ArrayList<org.dmc.services.components.Component>();
			...
			try {
					...
					components.add(
					new org.dmc.services.components.Component.ComponentBuilder(id, title, description).releaseDate(date)
...
public ArrayList<org.dmc.services.components.Component> getComponentList(int projectId){
